...
bool Color::operator==(const Color& other) const {
    if (_mode == Color_mode::RESET && other._mode == Color_mode::RESET) {
        return true;
    }
    return _mode == other._mode && _red == other._red && _green == other._green &&
           _blue == other._blue;
}
...
bool Color::operator<(const Color& other) const {
    ...
    if (other._mode == Color_mode::RESET) {
        return true;
    }

    if (_mode != other._mode) return _mode < other._mode;
    if (_red != other._red) return _red < other._red;
    if (_green != other._green) return _green < other._green;
    return _blue < other._blue;
}

bool Color::operator<=(const Color& other) const { return *this < other || *this == other; }
